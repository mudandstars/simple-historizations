...
class Container_be6a8f5839 extends _PHPStan_7d6f0f6a4\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService046(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_be6a8f5839 $container)
			{
	...
	public function createServiceContainer(): Container_be6a8f5839
	{
		return $this;
	}
