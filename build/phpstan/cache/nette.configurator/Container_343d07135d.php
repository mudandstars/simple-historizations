...
// source: /home/paul/dynamiq/packages/mudandstars/historize-model-changes/vendor/phpstan/extension-installer/src/../../../nunomaduro/larastan/extension.neon
...
class Container_343d07135d extends _PHPStan_7d6f0f6a4\Nette\DI\Container
{
	protected $tags = [
		...
		'phpstan.typeSpecifier.methodTypeSpecifyingExtension' => ['0220' => true, '0458' => true],
		'phpstan.rules.rule' => [
			'0288' => true,
			'0292' => true,
			'0293' => true,
		...
		'phpstan.typeSpecifier.staticMethodTypeSpecifyingExtension' => ['0459' => true],
	];
	...
	protected $wiring = [
		...
		'PHPStan\Reflection\PropertiesClassReflectionExtension' => [
			['077', '087', '088', '092', '0210', '0375', '0376', '0377', '0385'],
		],
		...
		'PHPStan\Type\MethodTypeSpecifyingExtension' => [['0220', '0458']],
		...
		'PHPStan\PhpDoc\TypeNodeResolverExtension' => [['0422', '0423', '0429', '0431', '0456']],
		...
		'PHPStan\Rules\Deprecations\DeprecatedClassHelper' => [['0455']],
		'PHPStan\PhpDoc\TypeNodeResolverAwareExtension' => [['0456']],
		'PHPStan\PhpDoc\PHPUnit\MockObjectTypeNodeResolverExtension' => [['0456']],
		'PHPStan\Type\PHPUnit\Assert\AssertFunctionTypeSpecifyingExtension' => [['0457']],
		'PHPStan\Type\PHPUnit\Assert\AssertMethodTypeSpecifyingExtension' => [['0458']],
		'PHPStan\Type\StaticMethodTypeSpecifyingExtension' => [['0459']],
		'PHPStan\Type\PHPUnit\Assert\AssertStaticMethodTypeSpecifyingExtension' => [['0459']],
		'PHPStan\Type\PHPUnit\InvocationMockerDynamicReturnTypeExtension' => [['0460']],
		'PHPStan\Type\PHPUnit\MockBuilderDynamicReturnTypeExtension' => [['0461']],
		'PHPStan\Type\PHPUnit\MockObjectDynamicReturnTypeExtension' => [['0462']],
		'PHPStan\Rules\PHPUnit\CoversHelper' => [['0463']],
		'PHPStan\Rules\PHPUnit\AnnotationHelper' => [['0464']],
		'PHPStan\Rules\PHPUnit\DataProviderHelper' => [['0465']],
		'PHPStan\Rules\PHPUnit\DataProviderHelperFactory' => [['0466']],
		'PHPStan\Rules\PHPUnit\ClassCoversExistsRule' => [['0467']],
		'PHPStan\Rules\PHPUnit\ClassMethodCoversExistsRule' => [['0468']],
		'PHPStan\Rules\PHPUnit\DataProviderDeclarationRule' => [['0469']],
		'PHPStan\Rules\PHPUnit\NoMissingSpaceInClassAnnotationRule' => [['0470']],
		'PHPStan\Rules\PHPUnit\NoMissingSpaceInMethodAnnotationRule' => [['0471']],
	];
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'bootstrapFiles' => [
				...
				'/home/paul/dynamiq/packages/mudandstars/historize-model-changes/vendor/nunomaduro/larastan/bootstrap.php',
			],
			'excludes_analyse' => [],
			...
			'additionalConfigFiles' => [
				...
				'/home/paul/dynamiq/packages/mudandstars/historize-model-changes/vendor/phpstan/extension-installer/src/../../../nunomaduro/larastan/extension.neon',
	...
	public function createService046(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_343d07135d $container)
			{
	...
	public function createService0455(): PHPStan\Rules\Deprecations\DeprecatedClassHelper
	{
		return new PHPStan\Rules\Deprecations\DeprecatedClassHelper($this->getService('reflectionProvider'));
	}


	public function createService0456(): PHPStan\PhpDoc\PHPUnit\MockObjectTypeNodeResolverExtension
	{
		return new PHPStan\PhpDoc\PHPUnit\MockObjectTypeNodeResolverExtension;
	}


	public function createService0457(): PHPStan\Type\PHPUnit\Assert\AssertFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\PHPUnit\Assert\AssertFunctionTypeSpecifyingExtension;
	}


	public function createService0458(): PHPStan\Type\PHPUnit\Assert\AssertMethodTypeSpecifyingExtension
	{
		return new PHPStan\Type\PHPUnit\Assert\AssertMethodTypeSpecifyingExtension;
	}


	public function createService0459(): PHPStan\Type\PHPUnit\Assert\AssertStaticMethodTypeSpecifyingExtension
	{
		return new PHPStan\Type\PHPUnit\Assert\AssertStaticMethodTypeSpecifyingExtension;
	}


	public function createService0460(): PHPStan\Type\PHPUnit\InvocationMockerDynamicReturnTypeExtension
	{
		return new PHPStan\Type\PHPUnit\InvocationMockerDynamicReturnTypeExtension;
	}


	public function createService0461(): PHPStan\Type\PHPUnit\MockBuilderDynamicReturnTypeExtension
	{
		return new PHPStan\Type\PHPUnit\MockBuilderDynamicReturnTypeExtension;
	}


	public function createService0462(): PHPStan\Type\PHPUnit\MockObjectDynamicReturnTypeExtension
	{
		return new PHPStan\Type\PHPUnit\MockObjectDynamicReturnTypeExtension;
	}


	public function createService0463(): PHPStan\Rules\PHPUnit\CoversHelper
	{
		return new PHPStan\Rules\PHPUnit\CoversHelper($this->getService('reflectionProvider'));
	}


	public function createService0464(): PHPStan\Rules\PHPUnit\AnnotationHelper
	{
		return new PHPStan\Rules\PHPUnit\AnnotationHelper;
	}


	public function createService0465(): PHPStan\Rules\PHPUnit\DataProviderHelper
	{
		return $this->getService('0466')->create();
	}


	public function createService0466(): PHPStan\Rules\PHPUnit\DataProviderHelperFactory
	{
		return new PHPStan\Rules\PHPUnit\DataProviderHelperFactory($this->getService('reflectionProvider'), $this->getService('0138'));
	}


	public function createService0467(): PHPStan\Rules\PHPUnit\ClassCoversExistsRule
	{
		return new PHPStan\Rules\PHPUnit\ClassCoversExistsRule($this->getService('0463'), $this->getService('reflectionProvider'));
	}


	public function createService0468(): PHPStan\Rules\PHPUnit\ClassMethodCoversExistsRule
	{
		return new PHPStan\Rules\PHPUnit\ClassMethodCoversExistsRule($this->getService('0463'), $this->getService('0138'));
	}


	public function createService0469(): PHPStan\Rules\PHPUnit\DataProviderDeclarationRule
	{
		return new PHPStan\Rules\PHPUnit\DataProviderDeclarationRule($this->getService('0465'), false, true);
	}


	public function createService0470(): PHPStan\Rules\PHPUnit\NoMissingSpaceInClassAnnotationRule
	{
		return new PHPStan\Rules\PHPUnit\NoMissingSpaceInClassAnnotationRule($this->getService('0464'));
	}


	public function createService0471(): PHPStan\Rules\PHPUnit\NoMissingSpaceInMethodAnnotationRule
	{
		return new PHPStan\Rules\PHPUnit\NoMissingSpaceInMethodAnnotationRule($this->getService('0464'));
	}
	...
	public function createServiceContainer(): Container_343d07135d
	{
		return $this;
	}
	...
	{
		return new PHPStan\Rules\Deprecations\TypeHintDeprecatedInClassMethodSignatureRule($this->getService('0455'));
	}


	public function createServiceRules__154(): PHPStan\Rules\Deprecations\TypeHintDeprecatedInClosureSignatureRule
	{
		return new PHPStan\Rules\Deprecations\TypeHintDeprecatedInClosureSignatureRule($this->getService('0455'));
	}


	public function createServiceRules__155(): PHPStan\Rules\Deprecations\TypeHintDeprecatedInFunctionSignatureRule
	{
		return new PHPStan\Rules\Deprecations\TypeHintDeprecatedInFunctionSignatureRule($this->getService('0455'));
	}
